...
!(function () {
  ...
  function r(n) {
    ...
    return (r = function (n) {
      if (
        null === n ||
        ((r = n), -1 === Function.toString.call(r).indexOf("[native code]"))
      )
        return n;
      var r;
    ...
    u = function (o) {
      var a = (function (o) {
        ...
        function u() {
          ...
          var t = (e = c.call(this)).attachShadow({ mode: "open" }),
      ...
      void 0 === customElements.get("mermaid-div") &&
        customElements.define("mermaid-div", a);
      var c = {
        startOnLoad: !1,
        theme: "default",
      ...
      var l =
        "undefined" == typeof mermaidConfig
          ? c
          : mermaidConfig[u] || mermaidConfig.default || c;
      mermaid.initialize(l);
      for (
        var d = document.querySelectorAll("pre.".concat(o, ", mermaid-div")),
          f = document.querySelector("html"),
          s = function (e) {
            var t = d[e],
              n =
                "mermaid-div" === t.tagName.toLowerCase()
                  ? t.shadowRoot.querySelector("pre.".concat(o))
                  : t,
